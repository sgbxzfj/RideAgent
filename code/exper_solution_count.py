...
if __name__ == "__main__":
    ...
    gurobi_model_path = f'/Users/admin/Documents/原文稿/jupyter/AAAI/experiment0720/model.mps'
    # csv_path = f'/Users/admin/Documents/原文稿/jupyter/AAAI/experiment0720/Demand_pattern/demand_pattern/total_data_{pattern}.csv'
    subdata_csv_path = f'/Users/admin/Documents/原文稿/jupyter/AAAI/experiment0720/s_split_{count}'
    supply_num = 42
    ...
    ###!!!personalized!!!###
        ...
        tnow = time.time()
        if In_sample:
            file_path = '/Users/admin/Documents/原文稿/jupyter/AAAI/exper_solution_count/{}/insample/index{}_sample{}_{}.txt'.format(count, Index, selected_num, tnow)
        else:
            file_path = '/Users/admin/Documents/原文稿/jupyter/AAAI/exper_solution_count/{}/outsample/index{}_sample{}_{}.txt'.format(count, Index, selected_num, tnow)
        f = open(file_path, 'w')
