...
if __name__ == "__main__":
    ...
    db_name = f'p_vehicle_{pattern}'
    randseed = 0  # 随机种子
    dv_num = 1032
    
    ###!!!personalized!!!###
    locality = 0.4
    Index = 'Reduce proportion of idle vehicles'
    In_sample = True  # 实验是否是in_sample的，True则从ground truth中抽样出index的gurobi语句和groundtruth_sample_num-1个随机指标
    groundtruth_sample_num = 8  # 从groundtruth字典中抽样放入indicator中的个数
    ###!!!personalized!!!###

    gurobi_model_path = f'/Users/admin/Documents/原文稿/jupyter/AAAI/experiment0720/Demand_pattern/MIP_model/model_{pattern}.mps'
    # csv_path = f'/Users/admin/Documents/原文稿/jupyter/AAAI/experiment0720/Demand_pattern/demand_pattern/total_data_{pattern}.csv'
    subdata_csv_path = f'/Users/admin/Documents/原文稿/jupyter/AAAI/experiment0720/p_split_{pattern}'
    supply_num = 42
    ...
    ###!!!personalized!!!###
        ...
        tnow = time.time()
        if In_sample:
            file_path = '/Users/admin/Documents/原文稿/jupyter/AAAI/exper_pattern/{}/insample/index{}_sample{}_{}.txt'.format(pattern, Index, selected_num, tnow)
        else:
            file_path = '/Users/admin/Documents/原文稿/jupyter/AAAI/exper_pattern/{}/outsample/index{}_sample{}_{}.txt'.format(pattern, Index, selected_num, tnow)
        f = open(file_path, 'w')
